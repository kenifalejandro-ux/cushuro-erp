      ...
      <div className="mb-12">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          ...
          <div className="flex items-center gap-2 text-sm text-slate-400">
            ...
            <span className="font-light">Actualizado {new Date().toLocaleTimeString('es-PE', { hour: '2-digit', minute: '2-digit' })}</span>
          </div>
        </div>
      </div>
...
{charts && (
  <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 mb-8">
    ...
    <StockMinimoChart data={charts.stock_vs_minimo} />
        ...
        {/* Stock Crítico Card */}
        <div className={`border rounded-xl p-6 hover:shadow-sm transition-all duration-300 ${
          ...
          <div className="flex items-start justify-between mb-8">
            <div className="space-y-0.5">
              <p className="text-xs font-medium text-slate-400 uppercase tracking-wide">Stock Crítico</p>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-6 hover:shadow-sm transition-all duration-300">
          <div className="flex items-start justify-between mb-8">
            <div className="space-y-0.5">
              <p className="text-xs font-medium text-slate-400 uppercase tracking-wide">Valor Total</p>
              <p className="text-3xl font-light text-slate-900 tracking-tight">
...
<div className={`border rounded-xl p-6 transition-all duration-300 ${
  ...
  <p className="text-xs text-slate-400 font-light">
    Capital comprometido en stock crítico
  </p>
</div>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-6 hover:shadow-sm transition-all duration-300">
          <div className="flex items-start justify-between mb-8">
            <div className="space-y-0.5">
              <p className="text-xs font-medium text-slate-400 uppercase tracking-wide">Combustible</p>
              <p className="text-3xl font-light text-slate-900 tracking-tight">
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-6">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-sm font-medium text-slate-400 uppercase tracking-wide">Documentación Legal</h2>
