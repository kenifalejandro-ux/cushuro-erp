...
**Los 4 módulos ya implementados, como ejemplo real** (en el orden en que se construyeron — cada uno agregó un caso que el anterior no tenía):
...
Ningún módulo de los 4 llegó completo a offline — en cada uno, algunas escrituras calificaron y otras no. Ese es el resultado esperado del criterio de la sección de arriba, no una limitación pendiente de resolver.
