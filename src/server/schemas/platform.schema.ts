...
export const cambiarPasswordPlatformAdminSchema = z.object({
...
export type CambiarPasswordPlatformAdminInput = z.infer<typeof cambiarPasswordPlatformAdminSchema>;
